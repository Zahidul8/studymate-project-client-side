...
const FindPartners = () => {
  ...
  return (
    <div>
          ...
          <form onSubmit={handleSearchPartner}>
            <div className="join">
              <label className="input validator join-item">
                ...
                <input type="search" className='bg-transparent' onChange={(e) => setSearchText(e.target.value)} name='search' placeholder="Search with subject" />
              </label>
      ...
      { loading ? <LoadingSpinner></LoadingSpinner> : partnerData.length === 0 ? 
