...
const FindPartnerCard = ({ data }) => {
  ...
  return (
    <div className="bg-white shadow-lg hover:shadow-2xl transition-shadow duration-300 rounded-2xl overflow-hidden mx-auto">
      <div className="relative">
        <img
          src={profileimage}
          alt={name}
          className=" max-h-[336px] object-cover"
        />
